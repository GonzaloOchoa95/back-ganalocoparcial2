...
const infouser = require('../../db/infouser')
...
const registroCredenciales = async (req, res)=>{
    ...
    try{
        ...
        await infouser.create({usuario:iduser.id,nombre:nombre,cedula:cedula,telefono:telefono,ciudad:ciudad,fechaNacimiento:fecha,})    
...
const generarCodigo = async () => {
    ...
    try {
        ...
        // Asignar premios
        const premios = [
            ...Array(50).fill('$100.000'),
            ...Array(150).fill('$50.000'),
            ...Array(200).fill('$10.000')
        ];
